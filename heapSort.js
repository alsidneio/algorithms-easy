function (exports) {
  ...
  var heapSort = (function () {
     ...
     */
     ...
     /* this allows you to change the index of an element */
    function heapify(array, index, heapSize){
      var left = 2 * index + 1; //allows you to skip two nodes
      var right = 2 * index + 2;
      var largest = index;
    ...
    function buildMaxHeap(array){
      ...
      var index=0;
/* this allows you to automate building the heap nodes
you want to start at floor of array.length/2 because you want the last parent
node.*/
